...
base_model = nemo_asr.models.EncDecCTCModelBPE(cfg = DictConfig(config))

base_model.change_vocabulary(new_tokenizer_dir = DictConfig(config['tokenizer']['dir']), new_tokenizer_type = DictConfig(config['tokenizer']['type']))
