...
app.layout = html.Div(children=[header, dash.page_container])  # Content of each page
...
if __name__ == "__main__":
    ...
    app.run_server(
        debug=False
    )  # Must run debug False to prevent extra audio fetching thread from being created
    audio_fetching.join()
